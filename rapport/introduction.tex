...
\todo[inline]{Before this section, you should have a separate, uncounted, page thanking those that have helped you.}
...
In addition, we wish to attempt to isolate each regular expression step \todo{finish with why}


These improvements should be particular useful in situations where ...\todo{write something about where ;)}
